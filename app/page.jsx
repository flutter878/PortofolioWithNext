      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col xl:flex-row items-center xl:items-start gap-12 xl:gap-20">
          ...
          <div className="flex-1 text-center xl:text-left max-w-2xl">
            ...
            <motion.p
              variants={itemVariants}
              className="text-muted-foreground text-sm sm:text-base md:text-lg leading-relaxed max-w-xl mx-auto xl:mx-0 mb-8"
            >
        ...
        <motion.div
          ...
          className="grid grid-cols-3 gap-6 mt-16 xl:mt-24 border-t border-border pt-12 max-w-2xl mx-auto xl:mx-0"
        >
